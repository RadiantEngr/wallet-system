...
var _a = require("../models/admin"), Admin = _a.Admin, validateAdmin = _a.validateAdmin;
var bcrypt_1 = __importDefault(require("bcrypt"));
var createAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, error, value, password, saltRounds, hashedPassword, newAdmin, data, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = validateAdmin(req.body), error = _a.error, value = _a.value;
                if (error) {

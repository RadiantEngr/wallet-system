...
var signUp = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, error, value, userName, email, password, random, heading, content, payload, saltRounds, hashedPassword, secret, token, user, newUser, data, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                secret = userName + "-" + hashedPassword;

...
exports.deleteTransaction = exports.deleteUser = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res.status(404).json({ Error: "The user you are trying to delete does not exist" })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, transaction_1.Transaction.findByIdAndDelete(id)];
            case 2:
                data = _a.sent();
                return [2 /*return*/, res.status(400).json(data)];
        }
